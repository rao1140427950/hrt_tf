...
class AdvancedEarlyStopping(tf.keras.callbacks.Callback):
    ...
    """
    def __init__(self, patience=3, filter_order=3, decay_rate=None, min_lr=None, log_dir=None, save_weights=None):
            ...
            if self.wait >= self.patience:
                ...
                if self.decay_rate is not None:
                    ...
                    if self.save_weights is not None:
                        self.model.save_weights(self.save_weights + 'epoch-%d.h5' % epoch)
                else:
